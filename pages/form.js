...
function Questionnaire({t}) {
    ...
    const isDisplay = (value, index) => ({ display: value === index ? 'block' : 'none' });
                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-10 align-self-center">
                            <Form
                                onSubmit={onSubmit}
                                render={({handleSubmit, form, submitting, pristine, values, hasValidationErrors, ...other}) => (
                                <form className={"form"} onSubmit={handleSubmit}>
                                        <div style={isDisplay(0, currentQuestion)}
                                            ...
                                            <div className="question">
                                                ...
                                                <div className="question_body">
                                                    <div className="question_item">
                                                        <label
                                                            className="question_label">{t('company-name')}</label>
                                                                ...
                                                                {({input, meta}) => (
                                                                    <div>
                                                                        ...
                                                                        {meta.error && meta.touched && <span
                                                                            className="form_required">{meta.error}</span>}
                                                                    </div>
                                                                )}
                                                            </Field>
                                                        </div>
                                                    ...
                                                    <div className="question_item">
                                                        <label
                                                            className="question_label">{t('company-site')}</label>
                                                        <div className="form_input form_input--input">
                                                            <Field name="company_site"
                                        ...
                                        <div style={isDisplay(1, currentQuestion)}
                                            ...
                                            <div className="question">
                                                ...
                                                <div className="question_body">
                                                    <div className="question_item">
                                                        <label
                                                            className="question_label">{t('person-first-name')}</label>
                                                        <div className="form_input form_input--input">
                                                    ...
                                                    <div className="question_item">
                                                        <label
                                                            className="question_label">{t('person-last-name')}</label>
                                                        <div className="form_input form_input--input">
                                                    ...
                                                    <div className="question_item">
                                                        <label
                                                            className="question_label">{t('person-middle-name')}</label>
                                                        <div className="form_input form_input--input">
                                        ...
                                        <div style={isDisplay(2, currentQuestion)}
                                            ...
                                            <div className="question">
                                                ...
                                                <div className="question_body">
                                                    ...
                                                    <div className="question_item">
                                                        <label
                                                            className="question_label">{t('date-duration')}</label>
                                                        <div className="form_input form_input--input">
                                        ...
                                        <div style={isDisplay(3, currentQuestion)}
                                            ...
                                            <div className="question">
                                                ...
                                                <div className="question_body">
                                                    <div className="question_item">
                                                        <label
                                                            className="question_label">{t('offer-position')}</label>
                                                        <div className="form_input form_input--input">
                                                            <Field name="offer_position"
                                                                   validate={composeValidators(required, minMaxValue(3)(30))}>
                                                                {({input, meta}) => (
                                                                    <div>
                                                                        <input
                                                    ...
                                                    <div className="question_item">
                                                        <label
                                                            className="question_label">{t('offer-salary')}</label>
                                                        <div className="form_input form_input--input">
                                                            <Field name="offer_salary"
                                                                   validate={composeValidators(required, minMaxValue(3)(30))}>
                                                                {({input, meta}) => (
                                                                    <div>
                                                                        <input
                                                    ...
                                                    <div className="question_item">
                                                        <label
                                                            className="question_label">{t('offer-description')}</label>
                                        ...
                                        <div style={isDisplay(4, currentQuestion)}
                                            ...
                                            <div className="question">
                                                ...
                                                <div className="question_body">
                                                    <div className="question_item">
                                                        <label
                                                            className="question_label">{t('source-source')}</label>
                                                        <div className="form_input form_input--input">
                                                            <Field name="source_source"
                                                                   validate={composeValidators(required, minMaxValue(3)(30))}>
                                                                {({input, meta}) => (
                                                                    <div>
                                                                        <input
                                            ...
                                            <div className="question">
                                                ...
                                                <div className="question_body">
                                                    <div className="question_item">
                                                        ...
                                                        <br/>
                                                        <br/>
                                                        <Field type="checkbox" name="sendToBankCard"
                                                               validate={required}>
                                                            {({input, meta}) => (
                                        ...
                                        <div className="form_buttons">
                                            <button disabled={currentQuestion === 0} className="button" type="button"
                                                    onClick={onPrevHandler}>{t('prev')}</button>
                                            <button className="button" type="submit"
                                                    disabled={submitting || pristine || hasValidationErrors}> {t('submit')}
                                            </button>
                                            <button className="button" type="button" onClick={form.reset}
                                                    disabled={submitting || pristine}> {t('reset')}
                                            </button>
                                            <button disabled={currentQuestion === 5} className="button" type="button"
                                                    onClick={onNextHandler}>{t('next')}</button>
                                        </div>
                                    </form>
                                )}
                            />
