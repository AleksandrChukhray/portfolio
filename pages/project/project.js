                            ...
                            <div className="project-page">
                                <div className="project-page_wrapper">
                                        ...
                                        <div className="slider slider--project" ref={slider} onClick={onClickHandler}>
                                            <div className="slider_item">
                                                <div className="slider_wrapper">
                                                    <img src="/static/img/bear.jpg" alt="" className="image"/>
                                    ...
                                    <div className="project-page_buttons">
                                        <a href="/" className="button button--download">View on Github</a>
                                        <a href="/" className="button button button--projects">Live view</a>
                                    </div>
                                </div>
                            </div>
                        </div>
